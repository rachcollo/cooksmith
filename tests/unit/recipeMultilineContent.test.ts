...
describe('recipe multiline content', () => {
  ...
  it('converts structured legacy recipes to multiline text only when source text is missing', () => {
    const recipe: Recipe = {
      ...
      favourite: false,
      ingredientRows: [
        { id: 'i1', name: 'lentils', quantity: '1', unit: 'cup', preparation: null, position: 1 },
        { id: 'i2', name: 'lemon', quantity: null, unit: null, preparation: 'juiced', position: 2 },
      ],
      steps: [
        { id: 's1', instruction: 'Simmer gently.', position: 1 },
        { id: 's2', instruction: 'Season and serve.', position: 2 },
      ],
      archivedAt: null,
