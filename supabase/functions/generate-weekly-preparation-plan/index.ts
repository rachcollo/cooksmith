...
async function savePlan(
  plan: ReturnType<typeof buildDeterministicWeeklyPreparationPlan>,
) {
  await rest(
    "weekly_preparation_plans?on_conflict=household_id,plan_key,cache_key",
    {
      method: "POST",
...
Deno.serve(async (request) => {
  ...
  try {
    ...
    const reason =
      error instanceof Error ? error.message : "temporarily_unavailable";
