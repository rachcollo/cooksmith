...
insert into cooksmith.weekly_preparation_evaluation_runs (
  ...
  'weekly-preparation-corpus-v11',
  'weekly-preparation-plan-v2',
  'weekly-preparation-planner-v11',
  'weekly-preparation-strategy-v11',
  'test-model',
  'test-pricing',
  30,
  0,
...
select
  ...
  case_number <= 27,
  case_number <= 27,
  case when case_number <= 27 then 'model-assisted' else 'deterministic' end,
  100,
  100,
  50,
  0,
