...
comment on function cooksmith.accept_weekly_preparation_evaluation(uuid) is
  'Allows an administrator to accept 28 of 30 quality passes only when every model output is valid and no fallback or unsupported evidence exists.';
