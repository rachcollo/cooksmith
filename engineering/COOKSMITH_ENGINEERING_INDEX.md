...
| 13 | Pantry-aware shopping indicator | CS-50 | `engineering/ready/cs50-pantry-aware-shopping-indicator.md` | Ready | CS-14, CS-21, CS-22 Done | `feat/cs-50-pantry-aware-shopping-indicator` |
...
- CS-50 is Ready for implementation. CS-52 retains its existing package; Jira/package lifecycle drift must be resolved before autonomous pickup.
