...
| 13 | Pantry-aware shopping indicator | CS-50 | `engineering/building/cs50-pantry-aware-shopping-indicator.md` | Building | CS-14, CS-21, CS-22 Done | `feat/cs-50-pantry-aware-shopping-indicator` |
...
- CS-50 is in implementation. CS-52 retains its existing package; Jira/package lifecycle drift must be resolved before autonomous pickup.
